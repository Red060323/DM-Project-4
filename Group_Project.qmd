...
<br><br> C- <u>Seizure and Education</u> <br>\<br\< (we do not keep)
...
# Densityof standardized residuals
...
We start with the Chi-squared test χ2.
...
# Categorization of quantity seized
joined_dataset$quantity_seized_category <- cut(joined_dataset$total_quantity_seized, 
                                               breaks = c(0, 10, 100, 500, 1000, Inf), 
                                               labels = c("0-10", "11-100", "101-500", "501-1000", "1001+"), 
                                               include.lowest = TRUE)
